...
img = cv2.imread("data/image/demo_real4.jpg")
...
imgThreshplate2 = cv2.resize(imgThreshplate2, None, fx=0.5, fy=0.5)
...
if detected == 1:
    ...
    for screenCnt in screenCnt:
        ...
        cv2.putText(img, first_line + "-" + second_line ,(topy ,topx),cv2.FONT_HERSHEY_DUPLEX, 1, (255, 87, 51), 2)
        n = n + 1
